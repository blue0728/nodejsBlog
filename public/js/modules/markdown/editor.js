...
// CodeMirror is the only global var we claim
        ...
        /**
         * Action for upload and draw an img.  by zhuxj 2015年4月15日 13:31:06
         */
        function uploadImage(editor) {
            ...
            require(['dialog', 'upload'], function (dialog, upload) {
                var html = '<div class="markdown-plugin-image">'
                    + '<div id="markdown-image-btn"></div>'
                    + '<div class="markdown-upload-tip">选择您要上传的图片（大小<span class="red">4M</span>&nbsp;&nbsp;尺寸<span class="red">800*600</span>）</div>'
                    + '<div class="markdown-loading orange" id="markdown-loading">上传中...</div></div>';
                ...
                var _dg = dialog({
                    ...
                    onshow: function () {
                        var uploader = new upload({
                            element: document.getElementById('markdown-image-btn'),
                            action: '/uploadPic/bigPic',
                            ...
                            onComplete: function (id, fileName, json) {
                                ...
                                if (json.status == 'success') {
                                    ...
                                    _replaceSelection(cm, stat.image, '![',''+sourcefile+']('+filename+')');
                                    _dg.close().remove();
